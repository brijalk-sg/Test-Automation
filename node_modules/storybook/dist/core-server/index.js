import CJS_COMPAT_NODE_URL_rd5c6f69z7a from 'node:url';
import CJS_COMPAT_NODE_PATH_rd5c6f69z7a from 'node:path';
import CJS_COMPAT_NODE_MODULE_rd5c6f69z7a from "node:module";

var __filename = CJS_COMPAT_NODE_URL_rd5c6f69z7a.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_rd5c6f69z7a.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_rd5c6f69z7a.createRequire(import.meta.url);
...
import {
  toEstree
} from "../_node-chunks/chunk-5T2S2CBF.js";
import {
  StatusTypeIdMismatchError
} from "../_node-chunks/chunk-57GCV357.js";
import {
  debounce,
  generateStoryFile,
  getErrorLevel,
  ...
  useStatics,
  withTelemetry
} from "../_node-chunks/chunk-GEQXL5UM.js";
import {
  detectPnp
} from "../_node-chunks/chunk-SSNBAGYW.js";
import "../_node-chunks/chunk-XIB23XKL.js";
import {
  StorybookError
} from "../_node-chunks/chunk-34LAANUM.js";
import {
  telemetry
} from "../_node-chunks/chunk-36GK4DVT.js";
import "../_node-chunks/chunk-EG6PEA77.js";
import {
...
} from "../_node-chunks/chunk-XG3C34PW.js";
import "../_node-chunks/chunk-Y2FVP6ZZ.js";
import "../_node-chunks/chunk-MUWE24NT.js";
import {
  require_pretty_hrtime
} from "../_node-chunks/chunk-F7RX436D.js";
import "../_node-chunks/chunk-MEKJHZLV.js";
import "../_node-chunks/chunk-CXCBCMJU.js";
import {
  invariant,
  up2 as up
} from "../_node-chunks/chunk-Q5ZXROJH.js";
import "../_node-chunks/chunk-Z775B5M5.js";
import {
  importModule,
  resolvePackageDir
} from "../_node-chunks/chunk-DR3WZNEO.js";
import {
  dirname,
  join,
  relative,
  resolve
} from "../_node-chunks/chunk-UTAOJTZT.js";
import {
  slash
} from "../_node-chunks/chunk-FLRSPERG.js";
import "../_node-chunks/chunk-NRUTWRCP.js";
import {
  Tag
} from "../_node-chunks/chunk-JCGNOCHR.js";
import {
  require_dist
} from "../_node-chunks/chunk-M6G6H4A2.js";
import {
  require_lib,
  require_src
} from "../_node-chunks/chunk-WPPF3GAW.js";
import {
  require_picocolors
} from "../_node-chunks/chunk-42M6GOLD.js";
import {
  __commonJS,
  __require,
  __toESM
} from "../_node-chunks/chunk-BQRGM2L4.js";
...
async function getManagerBuilder() {
  return await import("../_node-chunks/builder-manager-2W55VFCN.js");
}
  ...
  async function onChangeOrRemove(absolutePath, removed) {
    ...
    !removed && isDirectory(absolutePath) && await Promise.all(
      specifiers.filter((specifier) => importPath.startsWith(specifier.directory)).map(async (specifier) => {
        ...
        ), { globby } = await import("../_node-chunks/globby-6WRF6UCO.js");
...
var getAttr = (elt, what) => elt.attributes.find((n) => n.type === "JSXAttribute" && n.name.name === what), getAttrValue = (elt, what) => getAttr(elt, what)?.value, getAttrLiteral = (elt, what) => {
  ...
  let store = {
    ...
    metaTags: void 0,
    imports: void 0
  }, { compile } = await import("../_node-chunks/mdx-N42X6CFJ-6IXA5UPW.js");
  await compile(code, {
...
var makeAbsolute = (otherImport, normalizedPath, workingDir) => otherImport.startsWith(".") ? slash(resolve3(workingDir, normalizeStoryPath(join5(dirname2(normalizedPath), otherImport)))) : otherImport, StoryIndexGenerator = class _StoryIndexGenerator {
  ...
  static async findMatchingFiles(specifier, workingDir, ignoreWarnings = !1) {
    ...
    if (cached)
      return cached;
    let pathToSubIndex = {}, globCwd = slash(resolve3(workingDir, specifier.directory)), globPattern = specifier.files.startsWith("!") ? `./${specifier.files}` : specifier.files, { globby } = await import("../_node-chunks/globby-6WRF6UCO.js"), files = await globby(globPattern, {
      absolute: !0,
      cwd: globCwd,
